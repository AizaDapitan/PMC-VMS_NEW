      ...
      <div class="row ">
                  ...
                  <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:11px;">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>{{$item->ds}} </td>
                           <td>{{$item->de}} </td>
                           <td style="width:100px;"><a href="#" class="btn purple btn-xs" onclick="window.open("
                                 {{ route("downtime.downtime_edit", ["id" => $item->id ]) }}","displayWindow","toolbar=no,scrollbars=yes,width=1200,height=700");
                                 return false;><i class="fa fa-edit"></i></a>
                              <a href="#" class="btn red btn-xs deletedl" data="{{ $item->id }}"><i
         ...
         <div class="col-md-6 col-sm-6">
            <div class="portlet box  green-haze">
               ...
               <div class="portlet-body">
                  <iframe
                     src="{{ route('downtime.repairhours', ['start' =>  request()->get('start'), 'end' =>  request()->get('end')]) }}"
                     style="overflow : hidden;" frameborder="0" width="100%" scrolling="no" height="400"
                     style="-webkit-transform:scale(1.1);-moz-transform-scale(1.1);">
                  </iframe>
               </div>
            </div>
         </div>
      ...
      <div class="row">
         <div class="col-md-6 col-sm-6">
            <div class="portlet solid grey-cararra bordered">
               ...
               <div class="portlet-body">
                  <iframe
                     src="{{ route('downtime.mtdLightVehicle', ['start' =>  request()->get('start'), 'end' =>  request()->get('end')]) }}"
                     style="overflow : hidden;" frameborder="0" width="100%" scrolling="no" height="200"
                     style="-webkit-transform:scale(1.1);-moz-transform-scale(1.1);"></iframe>
               </div>
            </div>
         </div>
         <div class="col-md-6 col-sm-6">
            <div class="portlet solid grey-cararra bordered">
               ...
               <div class="portlet-body">
                  <iframe
                     src="{{ route('downtime.mtdMediumVehicle', ['start' =>  request()->get('start'), 'end' =>  request()->get('end')]) }}"
                     style="overflow : hidden;" frameborder="0" width="100%" scrolling="no" height="200"
                     style="-webkit-transform:scale(1.1);-moz-transform-scale(1.1);"></iframe>
               </div>
            </div>
      ...
      <div class="row">
         <div class="col-md-6 col-sm-6">
            <div class="portlet solid grey-cararra bordered">
               ...
               <div class="portlet-body">
                  <iframe
                     src="{{ route('downtime.repairtype', ['start' =>  request()->get('start'), 'end' =>  request()->get('end')]) }}"
                     style="overflow : hidden;" frameborder="0" width="100%" scrolling="no" height="200"
                     style="-webkit-transform:scale(1.1);-moz-transform-scale(1.1);"></iframe>
               </div>
            </div>
         ...
         <div class="col-md-6 col-sm-6">
            <div class="portlet solid grey-cararra bordered">
               ...
               <div class="portlet-body">
                  <iframe
                     src="{{ route('downtime.mtdHeavyVehicle', ['start' =>  request()->get('start'), 'end' =>  request()->get('end')]) }}"
                     style="overflow : hidden;" frameborder="0" width="100%" scrolling="no" height="200"
                     style="-webkit-transform:scale(1.1);-moz-transform-scale(1.1);"></iframe>
               </div>
            </div>
      ...
      <div class="row">
         <div class="col-md-6 col-sm-6">
            <div class="portlet solid grey-cararra bordered">
               ...
               <div class="portlet-body">
                  <iframe
                     src="{{ route('downtime.manhours', ['start' =>  request()->get('start'), 'end' =>  request()->get('end')]) }}"
                     style="overflow : hidden;" frameborder="0" width="100%" scrolling="no" height="200"
                     style="-webkit-transform:scale(1.1);-moz-transform-scale(1.1);"></iframe>
               </div>
            </div>
         ...
         <div class="col-md-6 col-sm-6">
            <div class="portlet solid grey-cararra bordered">
               ...
               <div class="portlet-body">
                  <iframe
                     src="{{ route('downtime.mtdMotor', ['start' =>  request()->get('start'), 'end' =>  request()->get('end')]) }}"
                     style="overflow : hidden;" frameborder="0" width="100%" scrolling="no" height="200"
                     style="-webkit-transform:scale(1.1);-moz-transform-scale(1.1);"></iframe>
               </div>
            </div>
      ...
      <div class="row">
         <div class="col-md-6 col-sm-6">
            <div class="portlet solid grey-cararra bordered">
               ...
               <div class="portlet-body">
                  <iframe
                     src="{{ route('downtime.rpLightVehicle', ['start' =>  request()->get('start'), 'end' =>  request()->get('end')]) }}"
                     style="overflow : hidden;" frameborder="0" width="100%" scrolling="no" height="200"
                     style="-webkit-transform:scale(1.1);-moz-transform-scale(1.1);"></iframe>
               </div>
            </div>
         ...
         <div class="col-md-6 col-sm-6">
            <div class="portlet solid grey-cararra bordered">
               ...
               <div class="portlet-body">
                  <iframe
                     src="{{ route('downtime.rpMediumVehicle', ['start' =>  request()->get('start'), 'end' =>  request()->get('end')]) }}"
                     style="overflow : hidden;" frameborder="0" width="100%" scrolling="no" height="200"
                     style="-webkit-transform:scale(1.1);-moz-transform-scale(1.1);"></iframe>
               </div>
            </div>
      ...
      <div class="row">
         <div class="col-md-6 col-sm-6">
            <div class="portlet solid grey-cararra bordered">
               ...
               <div class="portlet-body">
                  <iframe
                     src="{{ route('downtime.rpHeavyVehicle', ['start' =>  request()->get('start'), 'end' =>  request()->get('end')] ) }}"
                     style="overflow : hidden;" frameborder="0" width="100%" scrolling="no" height="200"
                     style="-webkit-transform:scale(1.1);-moz-transform-scale(1.1);"></iframe>
               </div>
            </div>
         ...
         <div class="col-md-6 col-sm-6">
            <div class="portlet solid grey-cararra bordered">
               ...
               <div class="portlet-body">
                  <iframe
                     src="{{ route('downtime.rpMotor', ['start' =>  request()->get('start'), 'end' =>  request()->get('end')]) }}"
                     style="overflow : hidden;" frameborder="0" width="100%" scrolling="no" height="200"
                     style="-webkit-transform:scale(1.1);-moz-transform-scale(1.1);"></iframe>
               </div>
            </div>
