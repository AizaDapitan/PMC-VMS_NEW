                           ...
                           <div class="row">
                              <div class="form-group col-md-12">
                                 ...
                                 <form role="form" action="{{ route('vehicle.dispatch.create', ['deptId' => $request->dept]) }}" method="POST">
                                    ...
                                    <div class="form-group col-md-12">
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <div class="input-group date form_datetime col-md-12" data-date="" data-date-format="yyyy-mm-dd HH:ii p" data-link-field="date_out">
                                             <div class="input-icon">
                                                <i class="fa fa-calendar font-yellow"></i>
                                                <input name="do" class="form-control" size="16" type="text" value="" required>
                                             </div>
                                             <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                                    ...
                                    <div class="form-group col-md-12">
                                       <div class="alert alert-info">
                                          <center style="font-family: times;"><b>FUEL SLIP FORM </b></center>
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <div class="input-icon">
                                             <i class="fa fa-tachometer font-yellow"></i>
                                             <input type="text" class="form-control" name="uom" placeholder="Unit of Measurement" value="Liter" required>
                                          </div>
                                       </div>
                                    </div>
